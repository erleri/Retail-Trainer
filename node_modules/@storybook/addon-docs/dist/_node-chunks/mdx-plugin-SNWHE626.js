...
import {
  compile
} from "./chunk-7NVOCRZU.js";
import "./chunk-TRCNSTUR.js";
import "./chunk-AT3IXFR2.js";
import {
  __commonJS,
  __toESM
} from "./chunk-CNAISQOW.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-AOTVR2Q2.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-5X4ZRZKU.js")).default;
  return {
