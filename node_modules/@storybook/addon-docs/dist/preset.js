import CJS_COMPAT_NODE_URL_9rmqpmiqu65 from 'node:url';
import CJS_COMPAT_NODE_PATH_9rmqpmiqu65 from 'node:path';
import CJS_COMPAT_NODE_MODULE_9rmqpmiqu65 from "node:module";

var __filename = CJS_COMPAT_NODE_URL_9rmqpmiqu65.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_9rmqpmiqu65.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_9rmqpmiqu65.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-CNAISQOW.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-AOTVR2Q2.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-5X4ZRZKU.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-SNWHE626.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {
