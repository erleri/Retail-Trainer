...
async function loadEnvs(options = {}) {
  let { getEnvironment } = await import("./lib-GX44WIWA.js"), defaultNodeEnv = options.production ? "production" : "development", env2 = {
...
async function scanAndTransformFiles({
  ...
  let globby = (await import("./globby-54L4JJRV.js")).globby, sourceFiles = await globby([glob2], {
    ...commonGlobOptions(""),
    ignore: ["**/node_modules/**"],
    dot: !0,
    cwd: getProjectRoot(),
...
var transformImportFiles = async (files, renamedImports, dryRun) => {
  let errors = [], { default: pLimit } = await import("./p-limit-QB7Q2I4D.js"), limit = pLimit(10);
  return await Promise.all(
    files.map(
      (file) => limit(async () => {
        try {
