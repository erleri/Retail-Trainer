...
export default function AdminLayout() {
    ...
    const desktopMenuItems = [
        ...
        { icon: Users, label: 'User Management', path: '/admin/users' }, // Added Missing Link
        { icon: ShoppingBag, label: 'Product Catalog', path: '/admin/products' },
        { icon: Users, label: 'Customer Engine', path: '/admin/customer' }, // Personas/Traits
        { icon: GitBranch, label: 'Sales Lab Rules', path: '/admin/sales-lab' }, // Upsell/Scenario
        { icon: Trophy, label: 'Gamification', path: '/admin/gamification' },
        { icon: FileText, label: 'Content (CMS)', path: '/admin/cms' },
        { icon: Activity, label: 'Analytics', path: '/admin/ai-quality' },
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row">
            ...
            {/* --- MAIN CONTENT AREA --- */}
            <main className="flex-1 w-full max-w-[1440px] mx-auto p-4 md:p-8 pb-24 md:pb-8 overflow-x-hidden">
                <Outlet />
            </main>
